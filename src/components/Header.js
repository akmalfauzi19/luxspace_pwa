      ...
      <div className="container mx-auto py-5">
        <div className="flex flex-stretch items-center">
          ...
          <div className="w-auto">
            <ul
              className="fixed bg-black inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
              id="menu"
            >
          ...
          <div className="w-auto">
            <ul className="items-center flex">
              ...
              <li className="ml-6">
                <Link
                  id="header-cart"
                  className="flex items-center justify-center w-8 h-8 text-black md:text-black"
                  to="/cart"
                >
                  <svg
                    className="fill-current"
